 ...
 */
@Slf4j
public class MySCPCommandFactory implements CommandFactory {

	private CommandFactory delegate;

	public MySCPCommandFactory() {
	}

	public MySCPCommandFactory(CommandFactory delegate) {
	...
	public Command createCommand(String command) {
		try {
			def cmd = splitCommandString(command)
			log.info "CMD:" + cmd
			return new ScpCommand(cmd);
		} 
